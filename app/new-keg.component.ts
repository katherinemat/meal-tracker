...
@Component({
  ...
  <div>
    <div>
      ...
      <button class="btn"(click)="submitForm(kegName.value, kegBrand.value, kegPrice.value, kegAlcoholContent.value); kegName.value=''; kegBrand.value=''; kegPrice.value=''; kegAlcoholContent.value=''">Done</button>
    </div>
  </div>
  `
})
